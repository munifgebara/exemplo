define(function (require) {
    ...
    require('app/modules/grupo/module');
                ...
                $httpProvider.interceptors.push(function ($q, $injector, $timeout, $filter) {
                    return {
                        'request': function (config) {
                            config.headers['gumgaToken'] = window.sessionStorage.getItem('user') != null ? JSON.parse(window.sessionStorage.getItem('user')).token : 0
                            return config
                        },
